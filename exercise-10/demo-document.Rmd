...
Given that we have  those two entries in the `biblio.bib` file, we can cite them in the document using the syntax `Here's a sentence that cites both papers [@Cooney_2017; @Silvestro_2014]`. Here's a sentence that cites both papers [@Cooney_2017; @Silvestro_2014].  use BIBTECH
